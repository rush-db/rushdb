    ...
    <div className="flex min-h-0 flex-1">
      <aside className="bg-fill2/40 flex w-56 shrink-0 flex-col border-r px-3 py-5">
        <div className="px-3 pb-4">
          <h2 className="text-content text-base font-semibold">Project Settings</h2>
          <p className="text-content2 mt-1 text-sm leading-6">Manage settings for this project.</p>
        </div>
