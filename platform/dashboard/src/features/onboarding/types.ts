...
export type AvailableSdkLanguage = Extract<SdkLanguage, (typeof AVAILABLE_SDK_LANGUAGES)[number]>

export const isSdkLanguageAvailable = (language: unknown): language is AvailableSdkLanguage => {
