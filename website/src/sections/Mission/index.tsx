export const Mission = () => {
  return (
    <section className="container mx-auto grid h-dvh max-w-3xl content-center items-center gap-4">
      <h3 className="text-3xl">Team & Mission</h3>
      <p className="text-content3 mb2 text-base">
        ...
        additions to database operations and search functionality. Every project required laborious data
        planning, ultracareful normalization, and custom retrieval solutions, creating unnecessary friction
        and delays.
      </p>
