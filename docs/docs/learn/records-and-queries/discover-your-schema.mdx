...
The same data as a graph — labels are nodes, relationships are edges:
...
The ontology method serialises this graph into a compact Markdown document ready for LLM injection:
