...
- [Store Records](/build/data/store-records) — flat record create / update / delete operations
- [Connect Records](/build/graph/connect-records) — manually attach/detach relationships
- [Write Records with Vectors](/build/ai-search/write-with-vectors) — attach embedding vectors at import time
