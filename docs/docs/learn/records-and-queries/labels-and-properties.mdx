---
slug: /build/schema/labels-and-properties
sidebar_position: 1
...
`db.labels.find()` accepts a standard [`where`](/reference/where-operators) clause. It returns all labels that have at least one record matching the condition.
...
- [Discover Your Schema](/build/schema/discover-your-schema) — live ontology via `db.ai.getOntology()`
- [Find & Query](/build/data/find-and-query) — query records by property value
- [Where Operators](/reference/where-operators) — filter syntax reference
