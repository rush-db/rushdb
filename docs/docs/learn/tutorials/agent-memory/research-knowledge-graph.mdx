---
slug: /tutorials/research-knowledge-graph
sidebar_position: 27
...
- [Hybrid Retrieval](/tutorials/hybrid-retrieval) — filter + semantic rank in one call
- [Modeling Hierarchies, Networks, and Feedback Loops](/tutorials/modeling-hierarchies) — structural patterns for citation networks
- [Data Lineage](/tutorials/data-lineage) — trace derived knowledge back to source papers
