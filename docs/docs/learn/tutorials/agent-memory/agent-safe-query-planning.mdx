---
slug: /tutorials/agent-safe-query-planning
sidebar_position: 22
...
- [Discovery Queries](/tutorials/discovery-queries) — interactive schema exploration in code
- [MCP Quickstart for Real Operators](/deploy/mcp-operator-quickstart) — the same loop via MCP tools
- [Building Team Memory](/tutorials/building-team-memory) — a real knowledge base for agents to query
