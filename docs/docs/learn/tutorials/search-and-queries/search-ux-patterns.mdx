---
slug: /tutorials/search-ux-patterns
sidebar_position: 30
...
- [Hybrid Retrieval](/tutorials/hybrid-retrieval) — two-phase structured-filter + semantic-rank for AI pipelines
- [Explainable Results](/tutorials/explainable-results) — surface evidence for every search result
- [Query Optimization](/tutorials/query-optimization) — shape queries for throughput and cost efficiency
