---
slug: /tutorials/event-driven-ingestion
sidebar_position: 29
...
- [Audit Trails](/tutorials/audit-trails) — append events to records without mutating them
- [Versioning Records](/tutorials/versioning-records) — maintain a history of every state transition
- [Supply Chain Traceability](/tutorials/supply-chain-traceability) — event-sourced causal chains across graph hops
