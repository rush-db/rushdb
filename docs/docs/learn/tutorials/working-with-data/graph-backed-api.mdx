---
slug: /tutorials/graph-backed-api
sidebar_position: 18
...
- [Hybrid Retrieval: Structured Filters Plus Semantic Search](/tutorials/hybrid-retrieval) — combining filter and vector search in one handler
- [Semantic Search for Multi-Tenant Products](/tutorials/semantic-search-multitenant) — tenant isolation at the storage layer
- [Query Optimization and KU Efficiency](/tutorials/query-optimization) — measuring and reducing compute cost
