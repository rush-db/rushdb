---
slug: /tutorials/importing-from-mongodb
...
- [Importing data from external sources](/tutorials/importing-data) — HubSpot, Postgres, Firebase, Airtable, Notion
- TypeScript SDK: [Import Data](/build/data/import-data) · [Relationships](/build/graph/connect-records)
- Python SDK: [Import Data](/build/data/import-data) · [Relationships](/build/graph/connect-records)
