---
slug: /tutorials/choosing-relationship-types
sidebar_position: 15
...
- [Modeling Hierarchies, Networks, and Feedback Loops](/tutorials/modeling-hierarchies) — three common graph shapes and how to query each
- [Thinking in Graphs: From Tables to Traversals](/tutorials/thinking-in-graphs) — the full mental model shift
- [SearchQuery Deep Dive](/tutorials/searchquery-advanced-patterns) — `$relation`, `$alias`, and aggregation patterns
