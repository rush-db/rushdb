---
slug: /tutorials/semantic-search-multitenant
sidebar_position: 14
...
- [Hybrid Retrieval: Structured Filters Plus Semantic Search](/tutorials/hybrid-retrieval) — combining semantic ranking with deeper graph traversal
- [RAG Pipeline in Minutes](/tutorials/rag-pipeline) — adding an LLM generation step on top of retrieval
- [Semantic Search reference](/build/ai-search/semantic-search) — full parameter reference
