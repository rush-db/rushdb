...
- [BYOV External Embeddings](/tutorials/byov-external-embeddings) — supply your own vectors instead of relying on managed embeddings
- [Multi-Source RAG](/tutorials/rag-multi-source) — combine PDFs, web pages, and database exports in one semantic search
- [RAG Evaluation](/tutorials/rag-evaluation) — measure precision and recall before deploying GraphRAG to production
