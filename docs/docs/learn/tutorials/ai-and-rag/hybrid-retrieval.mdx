---
slug: /tutorials/hybrid-retrieval
sidebar_position: 19
...
Before calling `db.ai.search`, a managed embedding index must exist and be ready for the label and property you want to search. See [Semantic Search for Multi-Tenant Products](/tutorials/semantic-search-multitenant) for setup instructions.
...
- [Semantic Search for Multi-Tenant Products](/tutorials/semantic-search-multitenant) — index setup and polling
- [Building a Graph-Backed API Layer](/tutorials/graph-backed-api) — integrate hybrid retrieval into a production handler
- [Temporal Graphs](/tutorials/temporal-graphs) — retrieve current-state records before semantic ranking
