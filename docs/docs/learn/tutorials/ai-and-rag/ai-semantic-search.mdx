---
slug: /tutorials/ai-semantic-search
sidebar_position: 5
...
- **Inject schema context into an LLM**: [TypeScript AI docs](/build/ai-search/semantic-search) | [Python AI docs](/build/ai-search/semantic-search)
- **REST API reference**: [REST AI docs](/rest-api/ai/overview)
