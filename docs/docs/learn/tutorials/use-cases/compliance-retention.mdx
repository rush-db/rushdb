---
slug: /tutorials/compliance-retention
sidebar_position: 26
...
5. **Keep a separate immutable EVENT record for each redaction action** — the redaction itself is an auditable fact; see [Audit Trails](/tutorials/audit-trails)
...
- [Versioning Records Without Losing Queryability](/tutorials/versioning-records) — keeping historical state alongside current state
- [Temporal Graphs](/tutorials/temporal-graphs) — point-in-time graph reconstruction
