...
| Page                                                               | Description                                                   |
| ------------------------------------------------------------------ | ------------------------------------------------------------- |
| [All MCP Tools](/reference/mcp/tools)                              | Complete catalog of all 37 tools, grouped by task             |
| [MCP Setup](/connect/mcp)                                          | Hosted OAuth, local client configuration, and troubleshooting |
| [Suggested Relationship Patterns](/build/graph/suggested-patterns) | Review and apply inferred relationship structures             |
