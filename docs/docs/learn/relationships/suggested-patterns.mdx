---
slug: /build/graph/suggested-patterns
sidebar_position: 3
...
For self-hosted deployments, see [Environment Variables](/deploy/config-env-variables). Omit these variables to disable AI relationship suggestions.
