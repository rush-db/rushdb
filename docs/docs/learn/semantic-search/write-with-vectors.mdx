---
slug: /build/ai-search/write-with-vectors
sidebar_position: 3
...
This feature requires at least one [external index](/build/ai-search/bring-your-own-vectors) on the target `(label, propertyName)`.
...
- [Bring Your Own Vectors](/build/ai-search/bring-your-own-vectors) — create external indexes and bulk-upsert
- [Manage Embedding Indexes](/build/ai-search/manage-indexes) — list, stats, delete indexes
- [Semantic Search](/build/ai-search/semantic-search) — search across indexed properties
