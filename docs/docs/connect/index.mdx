...
Need an API key for a local or application connection? [Create one in the dashboard](/deploy/get-api-key).
...
[Bootstrap persistent memory →](/build/agent-memory/quickstart)
...
| Use case                          | Guide                                                     |
| --------------------------------- | --------------------------------------------------------- |
| Persistent agent memory           | [Agent Memory Quickstart](/build/agent-memory/quickstart) |
| Semantic search over your data    | [Semantic Search](/build/ai-search/semantic-search)       |
| Graph-enriched retrieval          | [GraphRAG Tutorial](/tutorials/graphrag)                  |
| Explore an unknown dataset safely | [Discovery Queries](/tutorials/discovery-queries)         |
| Design labels and relationships   | [Data Modeling](/build/data/import-data)                  |
