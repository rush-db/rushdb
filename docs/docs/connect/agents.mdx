...
The agent calls `getOntologyMarkdown`, creates a `SESSION`, and validates recall. For the full bootstrap prompt and recommended labels, follow the [Agent Memory Quickstart](/build/agent-memory/quickstart).
...
If you have not bootstrapped memory yet, use the [Agent Memory Quickstart](/build/agent-memory/quickstart) first.

## Next Steps

- [Agent Memory Quickstart](/build/agent-memory/quickstart)
- [Schema Self-Awareness](/build/agent-memory/schema-self-awareness)
- [Agent-Safe Query Planning](/tutorials/agent-safe-query-planning)
- [Using RushDB Agent Skills in OpenClaw](/tutorials/agent-skills-with-openclaw)
