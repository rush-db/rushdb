...
1. [Create an embedding index](/build/ai-search/manage-indexes).
2. Wait until the index status is `ready`.
3. [Run semantic search](/build/ai-search/semantic-search).

## Full References

- [TypeScript / JavaScript reference](/reference/typescript/)
- [Python reference](/reference/python/)
- [REST API reference](/rest-api/introduction)
- [Store records](/build/data/store-records)
- [Import nested data](/build/data/import-data)
