...
See [Records](./records.md) for more on record structure, [Relationships](./relationships.md) for relationship types, and [Properties](./properties.md) for type inference details.
