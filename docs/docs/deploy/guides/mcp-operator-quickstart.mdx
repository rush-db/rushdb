---
slug: /deploy/mcp-operator-quickstart
sidebar_position: 13
...
- [Agent-Safe Query Planning with Ontology First](/tutorials/agent-safe-query-planning) — building repeatable agent patterns with failure recovery
- [Hybrid Retrieval: Structured Filters Plus Semantic Search](/tutorials/hybrid-retrieval) — combining semantic search with graph traversal
