...
See [Self-Hosting RushDB](/deploy/docker-remote) for the complete Docker Compose setup.
...
See [BYOC vs Managed vs Self-Hosted](/tutorials/byoc-vs-managed) for a full comparison.

---

## Next steps

- [BYOC vs Managed vs Self-Hosted](/tutorials/byoc-vs-managed) — choose the right topology
- [Self-Hosting RushDB](/deploy/docker-remote) — run both RushDB and the graph on your own infra
- [Project Setup After Deployment](/deploy/self-hosted-project-setup) — configure embedding models and team access per project
