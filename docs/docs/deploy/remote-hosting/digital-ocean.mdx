---
slug: /deploy/remote-digital-ocean
title: DigitalOcean
...
Verify the [Prerequisites](/deploy/remote-prerequisites) before continuing.
...
See [Environment Variables](/deploy/config-env-variables) for the full configuration reference.
