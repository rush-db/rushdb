...
See [Connecting an Aura Instance](/deploy/connect-aura) for the full BYOC walkthrough.
...
- [Project Setup After Deployment](/deploy/self-hosted-project-setup) — create projects, invite team members, configure per-project embedding models
- [Connecting an Aura Instance](/deploy/connect-aura) — use an existing Neo4j Aura database as the RushDB data store
- [BYOC vs Managed vs Self-hosted](/tutorials/byoc-vs-managed) — choose the right deployment topology for your use case
