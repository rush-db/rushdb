---
slug: /deploy/remote-cloud-providers
title: AWS / GCP / Azure
...
Verify the [Prerequisites](/deploy/remote-prerequisites) first.
...
See [Environment Variables](/deploy/config-env-variables) for the full `.env` reference.
...
Next: [Get your API Key](/deploy/get-api-key) to start using the instance.
