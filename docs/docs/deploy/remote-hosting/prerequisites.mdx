---
slug: /deploy/remote-prerequisites
title: Prerequisites
...
A custom domain with TLS is strongly recommended for any internet-facing deployment. See [Security](/deploy/config-security) for setup guidance.
