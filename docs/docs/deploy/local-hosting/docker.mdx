...
The Neo4j instance must have **APOC Core** installed (version must match Neo4j). See [Neo4j & Aura](/deploy/infra-neo4j) for details.
:::
...
See [Environment Variables](/deploy/config-env-variables) for the full reference.
